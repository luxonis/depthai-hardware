...
The OAK-FFC-IMX378 is a carrier board for the Arducam PY011 IMX378 camera module, and is designed to be compatible with the :ref:`DepthAI RPi HAT Baseboard <bw1094>` and 
...
the controller baseboards. We previously used Sunny A12N02A camera module.
