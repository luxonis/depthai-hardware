...
.. tabs::
    ...
    .. tab:: Overview
        ...
        As OAK-SoM-Pro-S3 is a drop-in replacement for OAK-SoM-Pro, you can replace it on some OAK devices (baseboards) that use it. Click on next tabs to see
        what PCBA changes need to be performed to get it working.

    .. tab:: OAK-FFC-4P

        Before replacing the SoM-Pro versions, you'd need to update the baseboard (:ref:`OAK-FFC-4P`) a bit, as boot sequence needs to be changed.
        You'd need to remove 2 resistors, move 2 resistors, and add one 0 Ω resistor.

        .. thumbnail:: /_static/images/SOM-PRO/ffc-4p-update-s2.png
        ...
        .. thumbnail:: /_static/images/SOM-PRO/ffc-4p-pro-s3.png
