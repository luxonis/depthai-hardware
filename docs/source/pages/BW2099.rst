...
a need for low power, high performance, real-time AI, and depth perception. It is ideal for use in industrial automation, robotics, and security systems.
...
.. tabs::
    ...
    .. tab:: OAK-SoM-Pro-S3 (RVC3, DM2399)
        ...
        **OAK-SoM-Pro-S3** has an on-board :ref:`RVC3`, which has **much greater AI performance** compared to :ref:`RVC2`,
