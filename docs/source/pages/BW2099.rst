...
.. figure:: /_static/images/SOM-PRO/som-pros-front.jpg
    ...
    **left**: OAK-SoM-Pro Series 3 RVP, **right**: OAK-SoM-Pro Myriad X
...
**OAK-SoM-Pro comes in two variants**: Myriad X (Gen2 Movidius VPU) based and :ref:`Series 3 Robotic Vision Processor (RVP) <OAK Series 3>` (Gen3 Movidius VPU) based SoM.
:ref:`Series 3 RVP` provides ~10x AI performance, quadcore ARM CPU, and enchanced stereo depth perception compared to Myriad X.

OAK-SoM-Pro Series 3 RVP was designed to be a drop-in replacement for OAK cameras that use
...
.. tabs::
    ...
    .. tab:: OAK-SoM-Pro S3 (Series 3 RVP, DM2399)

        .. image:: /_static/images/SOM-PRO/board-back.png

        **OAK-SoM-Pro S3** has an on-board :ref:`Series 3 RVP <OAK Series 3>`, which has **much greater AI performance** compared to Myriad X,
...
* :ref:`Series 3 RVP <OAK Series 3>` (Series 3) **unique features**:  2 GB RAM (16GBit)
...
- Series 3 RVP STEP `files here <https://github.com/luxonis/depthai-hardware/blob/master/SoMs/OAK-SoM-Pro-KB/DM2399_R1M0E1_AllComponents.step>`__

Altium Design Files
*******************

- Myriad X `files here <https://github.com/luxonis/depthai-hardware/tree/master/SoMs/OAK-SoM-Pro>`__
- Series 3 RVP `files here <https://github.com/luxonis/depthai-hardware/tree/master/SoMs/OAK-SoM-Pro-KB>`__
