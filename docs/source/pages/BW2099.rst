...
.. figure:: /_static/images/SOM-PRO/som-pros-front.jpg
    ...
    **left**: OAK-SoM-Pro-S3 (RVP3), **right**: OAK-SoM-Pro (Myriad X)
...
**OAK-SoM-Pro comes in two variants**: Myriad X based and :ref:`Series 3 Robotic Vision Processor (RVP3) <RVP3 Specifications>` based SoM.
:ref:`RVP3 <RVP3 Specifications>` provides ~10x AI performance, quadcore ARM CPU, and enchanced stereo depth perception compared to Myriad X.

OAK-SoM-Pro-S3 (RVP3) was designed to be a drop-in replacement for OAK cameras that use
...
.. tabs::
    ...
    .. tab:: OAK-SoM-Pro-S3 (RVP3, DM2399)

        .. image:: /_static/images/SOM-PRO/board-back.png

        **OAK-SoM-Pro-S3** has an on-board :ref:`RVP3 <OAK Series 3>`, which has **much greater AI performance** compared to Myriad X,
        ...
        **RVP3 inside**
        ...
        .. include:: /pages/includes/rvp3_inside.rst
...
* :ref:`RVP3 <OAK Series 3>` (Series 3) **unique features**:  2 GB RAM (16GBit)
...
.. figure:: /_static/images/SOM-PRO/som_pros_up.png
    ...
    **left**: OAK-SoM-Pro-S3, **right**: OAK-SoM-Pro Myriad X  
