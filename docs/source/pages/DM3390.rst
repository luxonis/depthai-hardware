...
`OAK-FFC-6P kit <https://shop.luxonis.com/products/oak-ffc-6p-with-oak-som-max-kit>`__
...
first device from :ref:`OAK Series 3` (with RVP3) and uses the :ref:`OAK-SoM-Max`.
...
In addition, an IMU (over SPI) sensor is also added to this OAK FFC board.
...
With cameras and the :ref:`OAK-SoM-Max`, the total power consumption usually stays below the 1.5 A specification. Type-C power
