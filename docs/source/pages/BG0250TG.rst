...
:ref:`OAK-FFC-3P` and :ref:`OAK-FFC-4P` baseboards. A 26-pin FFC is used to carry 5V power, 2-lane MIPI, I2C, and other
control signals between ththis camera module and the controller baseboard.
