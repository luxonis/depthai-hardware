...
Camera module compatibility is known for the Arducam OV9282 and previously used Sunny TG161B and AN01V32, but not tested for other modules. The FFC interface is an 0.5mm pitch, 
