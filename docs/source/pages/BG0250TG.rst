...
The OAK-FFC-OV9282 is a carrier board for the Arducam PY010 OV9282 camera module, and is designed to be compatible with the :ref:`DepthAI RPi HAT Baseboard <bw1094>` and 
...
controller baseboards. A single OAK-FFC-OV9282 is typically paired with another to create a stereo camera pair. We previously used Sunny TG161B or AN01V32 OV9282 camera module.
...
Camera module compatibility is known for the Arducam PY010 OV9282 and previously used Sunny TG161B and AN01V32, but not tested for other modules. The FFC interface is an 0.5mm pitch, 
