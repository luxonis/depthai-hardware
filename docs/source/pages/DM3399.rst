...
**OAK-SoM-Max** has on-board :ref:`Series 3 Robotic Vision Processor (RVP3) <OAK Series 3>`, which has **much greater AI performance**
compared to Myriad X, and **quadcore ARM CPU**. The OAK-SoM-Max is a System on Module (SoM) designed for integration into top-level system with
...
* Min/max data rates: RVP3 supports the following, all on I2C busses: 1) Standard Mode (100kHz), 2) Fast Mode (400kHz), 3) Fast Mode Plus (1MHz), and 4) High Speed Mode (3.4MHz)
