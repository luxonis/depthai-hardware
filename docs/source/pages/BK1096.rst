...
This is the open-source equivalent of OAK-1 (BW1093, megaAI) which uses the BW1099 SoM (System on Module). The BW1093 itself cannot be open-sourced 
...
The OAK-1-PCBA is designed to be powered from the USB Type-C connector. With the BW0249 camera and the DepthAI BW2099 SoM running 
