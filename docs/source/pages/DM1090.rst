...
DepthAI USB3 Edition (DM1090FFC)
================================

.. image:: /_static/images/DM1090FFC_R0M0E0_BOT.png
...
DM0249 RGB camera module. There is also a chance to connect three 2-lane MIPI camera modules i.e. DM0250TG if DM0249 RGB camera module is not required.

Please note that only revision R1M1E1 and newer camera modules can be connected to the 1090FFC. With DM1090FFC we gained support for 22-pin RPi camera 
...
.. image:: /_static/images/Flowchart_FFC.png
