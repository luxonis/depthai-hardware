...
The OAK-FFC-3P (DM1090FFC) baseboard has three FFC interfaces which allow for two 2-lane MIPI camera modules i.e. :ref:`DM0250TG <bg0250tg>` (stereo pair) and one 
...
Interfacing with the DepthAI SoM is also possible with OAK-FFC-3P connector pads J3, J4, and J5. These pads are designed for the Amphenol/FCI 
...
The 5V LED indicates 5V power is present on the OAK-FFC-3P. The PG LED indicates "power good" from the DepthAI SoM. The "RUN" LED indicates that the 
