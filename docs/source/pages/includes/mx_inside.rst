...
This OAK camera has on-board Intel's **Myriad X** VPU (`product pdf <https://newsroom.intel.com/wp-content/uploads/sites/11/2017/08/movidius-myriad-xvpu-product-brief.pdf>`__). Main features:
