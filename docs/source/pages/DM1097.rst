...
Based off of the :ref:`OAK-D-CM3 <bw1097>` and Raspberry PI CM4IO board, the OAK-D CM4 combines a host (RPi CM4) and the
...
The biggest difference between OAK-D-CM4 and :ref:`OAK-D-CM3 <bw1097>` architecture is that OAK-D-CM4 integrates CM4 module,
has gigabit ethernet, and is populated with MagJack supporting PoE. PoE can be used with additional PoE Hat.

Most OAK-D-CM4 devices have eMMC memory on-board. If you would like to flash a new image to it, follow the :ref:`tutorial here <Flashing an image to the eMMC>`.
