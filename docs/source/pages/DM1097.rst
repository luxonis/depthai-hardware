...
If the OAK-D-CM4 device does not come with a built-in WiFi module, a Tenda Wifi dongle can be used as an alternative. 
To enable the dongle, you will need to install the necessary drivers. Follow the steps below (`source <https://stackoverflow.com/questions/76495004/installing-tenda-w311mi-usb-adabter-on-ubuntu-22-04>`_) to install the drivers:
...
.. note::
    ...
    The Tenda Wifi dongle should be included in the box with the OAK-D-CM4 device.
