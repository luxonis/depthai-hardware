...
on the `OAK-D-Pro <https://github.com/luxonis/depthai-hardware/issues/114>`__ and `OAK-D-POE-Pro <https://github.com/luxonis/depthai-hardware/issues/142>`__,
which have on-board illumination IR LED and IR laser dot projector.

Connecting FSIN/STROBE
**********************

The upcoming `OAK-D-POE-Pro <https://github.com/luxonis/depthai-hardware/issues/142>`__ will have M8 I/O connector, which will also include
FSIN (frame sync) and STROBE (for driving a flash) signals.

If you won't be using the OAK-D-POE-Pro, you will need to solder a wire to the PCB on your device. Here's an example of STROBE trace on the `OAK-D-POE <https://github.com/luxonis/depthai-hardware/tree/master/SJ2088POE_PoE_Board>`__:
