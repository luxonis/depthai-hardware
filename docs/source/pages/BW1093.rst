...
Some part of the design cannot be open-sourced because it contains proprietary chip-down vendor information, and therefore cannot be shared publicly.
...
resulting in an 87,500 reduction in data your host has to deal with.
