...
.. thumbnail:: /_static/images/BW1093/oak-1.png
...
Its integrated 12 MegaPixel camera module communicates over an on-board 2.1 Gbps MIPI interface directly to the :ref:`RVC2`, which ingests this data 
...
.. include:: /pages/includes/imx378_ov9782.rst
...
* Support for :ref:`IMX378` 12MP RGB camera module
...
- Enclosure STEP files `here <https://github.com/luxonis/depthai-hardware/blob/master/BW1093_USB3C/Mechanical>`__

.. thumbnail:: /_static/images/BW1093/3d-enclosure.png
