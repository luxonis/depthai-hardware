...
`Buy it on Luxonis shop <https://shop.luxonis.com/collections/poe/products/oak-1-w-poe>`__
...
The **OAK-1-W-PoE** baseboard offers full 802.3af, Class 3 PoE compliance with 1000BASE-T speeds. The OAK-1-PoE (SJ2096POE)
baseboard has one on-board cameras which implement RGB vision, piped directly into the :ref:`OAK-SoM-Pro` for depth and AI
processing. The data is then output to a host via USB 3.1 Gen1 (Type-C) or via 1000BASE-T ethernet connection. The OAK-1-W-PoE
...
.. include:: /pages/includes/imx378_w_ov9782_w.rst 
